const CACHE_NAME = 'minimal-system-v111';
...
const APP_SHELL = [
  ...
  './manifest.json',
  './css/style.css',
  // Font ora ospitati in proprio (prima da fonts.googleapis.com): il
  // gestore 'fetch' mette in cache solo le risposte same-origin, quindi i
  // font di Google non venivano precaricati mai — alla prima apertura
  // offline il testo restava senza i caratteri del marchio. Da locali,
  // vanno nell'app shell come il resto.
  './css/fonts.css',
  './css/fonts/rajdhani-23afdb9b5b-latin.woff2',
  './css/fonts/rajdhani-433a7007e4-latin.woff2',
  './css/fonts/rajdhani-5b7e4a6f97-latin.woff2',
  './css/fonts/rajdhani-16fd373954-latin-ext.woff2',
  './css/fonts/rajdhani-c6b9df5874-latin-ext.woff2',
  './css/fonts/rajdhani-f57c2b379b-latin-ext.woff2',
  './css/fonts/inter-3100e775e8-latin.woff2',
  './css/fonts/inter-34b9c504ca-latin-ext.woff2',
  './css/fonts/jetbrains-mono-83c005d49d-latin.woff2',
  './css/fonts/jetbrains-mono-db5ff4db83-latin-ext.woff2',
  './js/startup.js',
  './js/intro.js',
  './js/brand.js',
  './js/version.js',
