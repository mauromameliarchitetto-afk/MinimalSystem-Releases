...
function updateRmNav(name) {
  ...
  const activeMap = { cover: 'cover', home: 'home', list: 'charlist', campaigns: 'storie', account: 'storie', rules: 'rules', search: 'search' };
...
function wireStaticEvents() {
  ...
  $('#home-rules-cta').addEventListener('click', () => goToMenuTarget('rules'));
  $('#home-library-cta').addEventListener('click', () => goToMenuTarget('library'));
  ...
  $('#btn-profile-avatar').addEventListener('click', () => { renderAccountArea(); showView('account'); });
