/* ==========================================================================
   ...
   minimalsystem://). Richiede aggiornare la redirect URI nella console
   OAuth (Google/Apple) e in Supabase Auth non appena la build con la
   nuova identità viene distribuita, altrimenti il login smette di
   funzionare fino all'aggiornamento. localStorage/cache/repository NON
